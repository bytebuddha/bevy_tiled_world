        ...
        entity
            ...
            .insert_bundle(RigidBodyBundle {
                ...
                position: Vec2::new(
                    ...
                    map.height as f32 * map.tile_height as f32 - object.y
                        + map.tile_height as f32 / 2.0,
                )
                .into(),
                ..Default::default()
            });
...
fn get_rigid_body_type(object: &Object) -> RigidBodyType {
    if let Some(body_ty) = object.properties.get("RigidBodyType") {
        match body_ty {
            PropertyValue::StringValue(body_ty) => match body_ty.as_str() {
